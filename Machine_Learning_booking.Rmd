...
dt_2016_all$new_date <- as.Date(paste(dt_2016_all$arrival_date_day_of_month, "-", dt_2016_all$arrival_date_month, "-", dt_2016_all$arrival_date_year), c("%d - %B - %Y"))
